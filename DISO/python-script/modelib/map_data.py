...
def main():
    ...
    path_nickel_cif = "../../../CSO/data/MaterialProject/Nickel/json/Ni_mp-23_conventional_standard.json"
    path_nickel_space_group = "../../../CSO/data/MaterialProject/Nickel/spacegroup/mp-23_spacegroup.json"
